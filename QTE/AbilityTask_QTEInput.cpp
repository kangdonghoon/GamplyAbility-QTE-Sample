...
UAbilityTask_QTEInput* UAbilityTask_QTEInput::StartQTESequence(
	UGameplayAbility* OwningAbility,
	FQTESequenceData InSequenceData,
	TSubclassOf<UQTEWidget> InWidgetClass)
{
...
void UAbilityTask_QTEInput::ShowQTEWidget()
{
	...
	ActiveWidget = ::CreateWidget<UQTEWidget>(PC, WidgetClass);
